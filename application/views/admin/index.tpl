...
<div id="sidebar">
	<div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
		...
		<div id="profile-links">
			Hello, <a href="{$base_url}admin/user/edit/{$ci->session->userdata.userId}" title="Edit your profile">{$ci->session->userdata.userEmail}</a>{*, you have <a href="#messages" rel="modal" title="3 Messages">3 Messages</a>*}
			<br/>
			<br/>
...
<!-- Page Head -->
<h2>Welcome {$ci->session->userdata.userEmail}</h2>
...
{*
	<li><a class="shortcut-button" href="#"><span>
					<img src="{$base_url}resources/admin/images/icons/pencil_48.png" alt="icon"/><br/>
					Write an Article
				</span></a></li>
*}

	<li><a class="shortcut-button" href="#"><span>
					<img src="{$base_url}resources/admin/images/icons/paper_content_pencil_48.png" alt="icon"/><br/>
					Create a New Page
				</span></a></li>

	<li><a class="shortcut-button" href="#"><span>
					<img src="{$base_url}resources/admin/images/icons/image_add_48.png" alt="icon"/><br/>
					Upload an Image
				</span></a></li>

{*
	<li><a class="shortcut-button" href="#"><span>
					<img src="{$base_url}resources/admin/images/icons/clock_48.png" alt="icon"/><br/>
					Add an Event
				</span></a></li>
*}
...
{*
	<li><a class="shortcut-button" href="#messages" rel="modal"><span>
					<img src="{$base_url}resources/admin/images/icons/comment_48.png" alt="icon"/><br/>
					Open Modal
				</span></a></li>
*}
...
<div class="content-box"><!-- Start Content Box -->
	...
	<div class="tab-content default-tab" id="tab1">
		...
		<div class="notification attention png_bg">
			<a href="#" class="close"><img src="{$base_url}resources/admin/images/icons/cross_grey_small.png"
		...
		<table>
			...
			<tr>
				...
				<td>
					<!-- Icons -->
					<a href="#" title="Edit"><img src="{$base_url}resources/admin/images/icons/pencil.png" alt="Edit"/></a>
					<a href="#" title="Delete"><img src="{$base_url}resources/admin/images/icons/cross.png"
													alt="Delete"/></a>
					<a href="#" title="Edit Meta"><img src="{$base_url}resources/admin/images/icons/hammer_screwdriver.png"
													   alt="Edit Meta"/></a>
				</td>
			</tr>
		...
		<form action="#" method="post">
			...
			<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
				...
				<p>
					...
					<input type="checkbox" name="checkbox1"/> This is a checkbox <input type="checkbox" name="checkbox2"/>
